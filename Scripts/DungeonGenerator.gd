...
func generate_map() -> void:
	...
	draw_count_generation(map_dimensions, boundary_padding, TILE_DATA.floor.source_id, TILE_DATA.floor.atlas_coords)


# draw boundary and fill it in 
...
# fill in actual boundary
func draw_count_generation(dimensions: Vector2i, padding: int, source_id: int, atlas_coords: Vector2i) -> void:
